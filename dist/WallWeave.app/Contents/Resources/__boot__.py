...
_recipes_pil_prescript(['BufrStubImagePlugin', 'PngImagePlugin', 'DdsImagePlugin', 'SgiImagePlugin', 'Jpeg2KImagePlugin', 'TgaImagePlugin', 'FitsStubImagePlugin', 'PixarImagePlugin', 'MspImagePlugin', 'DcxImagePlugin', 'McIdasImagePlugin', 'PdfImagePlugin', 'IcnsImagePlugin', 'MpegImagePlugin', 'WmfImagePlugin', 'ImImagePlugin', 'BlpImagePlugin', 'PcxImagePlugin', 'SpiderImagePlugin', 'XbmImagePlugin', 'IptcImagePlugin', 'GribStubImagePlugin', 'TiffImagePlugin', 'FitsImagePlugin', 'ImtImagePlugin', 'WebPImagePlugin', 'FliImagePlugin', 'MpoImagePlugin', 'EpsImagePlugin', 'Hdf5StubImagePlugin', 'CurImagePlugin', 'GifImagePlugin', 'GbrImagePlugin', 'SunImagePlugin', 'PalmImagePlugin', 'BmpImagePlugin', 'PcdImagePlugin', 'PsdImagePlugin', 'PpmImagePlugin', 'JpegImagePlugin', 'XpmImagePlugin', 'FpxImagePlugin', 'XVThumbImagePlugin', 'MicImagePlugin', 'FtexImagePlugin', 'IcoImagePlugin'])
