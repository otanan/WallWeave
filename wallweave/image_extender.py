...
#======================== Modifiers ========================#
def by_blur(img, monitor, blur_intensity=20):
...
def by_mirror(img, monitor):
    """ Extends the image by mirroring the sides to fill up remaining space. Written by Joseph Farah. """
...
def main():
    ...
    # Testing papers
    # Standard
    path = PAPERS_PATH / 'dbz-4s-7bc767.jpg'
    # Mobile
